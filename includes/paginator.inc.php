...
**
**
**	Versión 1.6.2	(18/04/2017):	-Se migro para usar con MySQLi.
**
**-----------------------------------------------------------------------------------------------------------*/
 ...
 * ------------------------------------------------------------------------
 * $_pagi_con					OBLIGATORIA. Link de mysqlli de la conexión.
...
/* Función adicional para soporte de migracion de mysql_result a MySQLi*/
 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
    ...
    $_pagi_result2 = mysqli_query($_pagi_con,$_pagi_sqlConta);
	// Si ocurrió error y mostrar errores está activado
 	if($_pagi_result2 == false && $_pagi_mostrar_errores == true){
		die (" Error en la consulta de conteo de registros: $_pagi_sqlConta. Mysql dijo: <b>".mysqli_errno()."</b>");
 	}
 	$_pagi_totalReg = mysqli_result($_pagi_result2,0,0);//total de registros
 }else{
	$_pagi_result3 = mysqli_query($_pagi_con,$_pagi_sql);
	// Si ocurrió error y mostrar errores está activado
 	if($_pagi_result3 == false && $_pagi_mostrar_errores == true){
		die (" Error en la consulta de conteo alternativo de registros: $_pagi_sql. Mysql dijo: <b>".mysqli_errno()."</b>");
 	}
 ...
 */
 ...
 $_pagi_result = mysqli_query($_pagi_con,$_pagi_sqlLim);
 // Si ocurrió error y mostrar errores está activado
 if($_pagi_result == false && $_pagi_mostrar_errores == true){
 	die ("Error en la consulta limitada: $_pagi_sqlLim. Mysql dijo: <b>".mysqli_errno()."</b>");
 }
